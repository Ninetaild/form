...
const notice=[
 ...
 ['4. 확장 프로그램 권한','자동 입력을 위해 확장 프로그램에는 http/https 웹사이트에서 동작할 호스트 권한이 필요합니다. 이 권한은 설치 시 Chrome에서 안내되며, Kit 실행 시 대상 페이지에만 자동 입력 기능을 연결합니다.'],
 ['5. 실행 범위','확장 프로그램은 Kit에 지정된 URL을 새 탭으로 열고 해당 페이지에만 정해진 답변 입력 기능을 실행합니다. 개인정보를 별도의 개발자 서버로 전송하지 않습니다.'],
