...
const notice=[
 ...
 ['4. 확장 프로그램 권한','확장 프로그램은 설치만으로 모든 웹사이트에 접근하지 않습니다. Kit 실행 시 대상 사이트의 호스트 권한을 요청하고, 허용된 경우에만 해당 사이트의 페이지를 읽고 정해진 답변을 입력·선택합니다.'],
